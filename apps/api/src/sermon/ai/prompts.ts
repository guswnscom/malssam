...
## 비유와 예화 규칙 (중요)
- 단순한 주석적 해석에 머물지 마세요. 본문의 의미를 현대 삶의 구체적 상황에 깊이 있게 비유하세요.
- 각 대지에서 본문의 핵심 구절 중 1~2개를 선정하여, 같은 주제를 다루는 다른 성경 구절(참조구절)을 함께 제시하세요.
- 참조구절은 본문의 의미를 더 풍부하게 해주는 구절이어야 합니다 (교차참조, 병행구절, 주제적 연결).
- 비유는 "~와 같습니다"로 끝나는 단순 비유가 아니라, 구체적 이야기와 감정을 담아 청중이 경험으로 느낄 수 있도록 깊이 있게 풀어쓰세요.
- 역사적 배경, 원어 의미, 당시 문화적 맥락을 활용하여 본문을 입체적으로 조명하세요.
...

{
  ...
  "introduction": "서론",
  "outline": [
    {"point": 1, "title": "대지 제목", "content": "대지 내용. 본문의 핵심 구절을 깊이 있게 풀고, 참조구절(예: 로마서 8:28)을 함께 제시하여 의미를 풍부하게 하세요."},
    {"point": 2, "title": "대지 제목", "content": "대지 내용. 다른 참조구절을 통해 본문의 메시지를 다각도로 조명하세요."},
...
1. 해당 구절의 의미를 단순 해석이 아니라 삶의 경험과 연결하여 깊이 있게 풀어주세요.
2. 같은 주제나 메시지를 담은 다른 성경구절(참조구절)을 1~2개씩 제시하고, 그 구절이 본문과 어떻게 연결되는지 설명해주세요.
3. 예시: "본문의 '두려워하지 말라'는 이사야 41:10의 '내가 너와 함께 함이라'와 같은 맥락입니다. 하나님은..."
4. 참조구절을 통해 성경 전체가 하나의 메시지로 연결됨을 보여주세요.`;
